    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          <span className="text-sm font-bold text-[#8b5e3c] tracking-widest uppercase">
            CREATIVE JOURNALING
          </span>
    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          ...
          <p className="mt-4 text-xl text-slate-100 font-light">
            Fine pens, permanent markers, and watercolor paint sets.
          </p>
    ...
    content: (
      <>
        <div className="z-10 max-w-lg flex flex-col justify-center items-start">
          <span className="text-sm font-bold text-red-300 tracking-widest uppercase">

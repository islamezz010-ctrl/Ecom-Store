...
const slides = [
    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          <span className="text-sm font-bold text-[#8c6239] tracking-widest uppercase">
            SUPER SOFT FABRICS
          </span>
  ...
  },
  {
    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          <span className="text-sm font-bold text-[#0369a1] tracking-widest uppercase">
            TRAVEL GEAR
          </span>
          ...
          <p className="mt-4 text-xl text-[#0369a1] font-light">
            Engineered for comfort and top safety standards.
          </p>
    ...
    content: (
      <>
        <div className="z-10 max-w-lg flex flex-col justify-center items-start">
          <span className="text-sm font-bold text-[#15803d] tracking-widest uppercase">
            FEEDING ESSENTIALS
          </span>

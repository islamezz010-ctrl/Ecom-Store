...
const slides = [
    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          <span className="text-sm font-bold text-[#00d2d3] tracking-widest uppercase">
            TRAIN HARDER
          </span>
  ...
  },
  {
    ...
    content: (
      <>
        <div className="z-10 max-w-lg">
          <span className="text-sm font-bold text-[#fed330] tracking-widest uppercase">
            OUTDOOR ADVENTURE
          </span>
          ...
          <p className="mt-4 text-xl text-indigo-100 font-light">
            Tents, sleeping bags, and heavy duty hiking backpacks.
          </p>

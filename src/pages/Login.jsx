...
const Login = () => {
  ...
  return (
    <div className="flex h-screen w-screen bg-mist-300">
      <form onSubmit={handleLogin} className="flex flex-col p-8 bg-white gap-5 items-center w-170 dark:bg-gray-900 mt-10 mx-auto h-120 rounded-3xl border border-gray-100 dark:border-gray-800 shadow-2xl">
        ...
        />
        <Button type="submit" className="w-40 py-6 mt-7 bg-gray-900 dark:bg-blue-600 text-white font-bold rounded-xl hover:scale-[1.02] transition-transform">
          Sign In
        </Button>
